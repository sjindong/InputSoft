...
public class Environment {
	 ...
	 */
	private static final float CANDIDATES_AREA_HEIGHT_RATIO_LANDSCAPE = 0.084f;
	 ...
	 */
	private static final float KEY_BALLOON_HEIGHT_PLUS_RATIO = 0.09f;

	/**
	 * The text size for normal keys. It is relative to the smaller one of
	 * screen width and height. 正常按键的文本的大小，值是相对于屏幕高度和宽度较小的那一个。
	 */
	private static final float NORMAL_KEY_TEXT_SIZE_RATIO = 0.08f;
	 ...
	 */
	private static final float FUNCTION_KEY_TEXT_SIZE_RATIO = 0.07f;
	...
	public void onConfigurationChanged(Configuration newConfig, Context context) {
		if (mConfig.orientation != newConfig.orientation) {
			...
			mScreenHeight = (int) (d.getHeight()/1.10f);
